...
class AwsomeDialogs extends StatefulWidget {
  const AwsomeDialogs({Key? key}) : super(key: key);

  @override
  State<AwsomeDialogs> createState() => _AwsomeDialogsState();
}

class _AwsomeDialogsState extends State<AwsomeDialogs> {
  @override
